...
def run_script_and_save_results(script_path, output_file, max_runs=100):
    ...
    while True:
        ...
        with open("resultAbers_Bis_MultiComo.pkl", "rb") as f:
...
if __name__ == "__main__":
    script_path = "Pays_Abers_Bis_MultiComo.py"  # Chemin vers le script de l'algorithme
    output_file = "resultsAbers_Bis_MultiComo.txt"  # Fichier où les résultats seront enregistrés
