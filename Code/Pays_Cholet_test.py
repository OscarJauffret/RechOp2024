...
def genetic_algorithm(init_sol, population_size, best_scores, variances, carried_over_proportion=0.4):
    ...
    while time.time() - start_time < 600:
        ...
        best_solution_age = population[0][1]
        ...
        # Dynamically adjust the intensity of mutation and the proportion of new children
        #mutation_intensity = max(1, 5 - int(time.time() - start_time / 100))  # Reduce mutation intensity over time
