...
def run_script_and_save_results(script_path, output_file, max_runs=100):
    ...
    while True:
        ...
        with open("resultCholet.pkl", "rb") as f:
...
if __name__ == "__main__":
    script_path = "41800Cholet.py"  # Chemin vers le script de l'algorithme
    output_file = "resultsCholet.txt"  # Fichier où les résultats seront enregistrés
