...
def run_script_and_save_results(script_path, output_file, max_runs=100):
    ...
    while True:
        ...
        with open("resultAbers_Bis.pkl", "rb") as f:
...
if __name__ == "__main__":
    script_path = "Pays_Abers_Bis.py"  # Chemin vers le script de l'algorithme
    output_file = "resultsAbers_Bis.txt"  # Fichier où les résultats seront enregistrés
